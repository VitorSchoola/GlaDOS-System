...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Avaliar\"><br> \n" );
		fclose ( reading );
	...
	else
	{
		...
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Evaluate\"><br> \n" );
		fclose ( reading );
