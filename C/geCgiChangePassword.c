...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		printf("    Mudar senha: <br>\n" );
		printf ("<form action=\"geExecuteChangePassword.cgi\" method=\"post\"> \n" );
		...
		printf ("  </script> \n");
			...
			printf (" <b>Senha Antiga</b>: <br>\n" );
			printf (" <input type='password' name='geOldPassword' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
			
			printf (" <b>Confirmar Senha Antiga</b>: <br>\n" );
			printf (" <input type='password' name='geOldPasswordConfirmation' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
	
			printf (" <b>Senha Nova</b>: <br>\n" );
			printf (" <input type='password' name='geNewPassword' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
			
			printf (" <b>Confirmar Senha Nova</b>: <br>\n" );
			printf (" <input type='password' name='geNewPasswordConfirmation' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
	...
	else
	{
		...
		printf ("  </script> \n");
			...
			printf (" <b>Old Password</b>: <br>\n" );
			printf (" <input type='password' name='geOldPassword' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
			
			printf (" <b>Old Password's Confirmation</b>: <br>\n" );
			printf (" <input type='password' name='geOldPasswordConfirmation' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
	
			printf (" <b>New Password</b>: <br>\n" );
			printf (" <input type='password' name='geNewPassword' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
			
			printf (" <b>New Password's Confirmation</b>: <br>\n" );
			printf (" <input type='password' name='geNewPasswordConfirmation' maxlength='%u'><br>\n", PASSWORD_MAX_LENGTH );
...
/* $RCSfile: geCgiChangePassword.c,v $ */
