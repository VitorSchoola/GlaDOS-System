...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		{
			printf("    Remover Cervejas: <br>\n" );
			printf ("<form action=\"geExecuteRemoveBeer.cgi\" method=\"post\"> \n" );
