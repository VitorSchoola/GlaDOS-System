...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		if ( userLoggedIn.group == 1 )
		{
			...
			printf ("<form action=\"geExecuteRemoveBeerType.cgi\" method=\"post\"> \n" );
	...
	else
	{
		...
		if ( userLoggedIn.group == 1 )
		{
			...
			printf (" <b>Linting of all Beer Types</b>:<br>\n" );
...
/* $RCSfile: geCgiRemoveBeerType.c,v $ */
