...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		printf("    Adicionar Tipo de Cerveja: <br>\n" );
		printf ("<form action=\"geExecuteAddBeerType.cgi\" method=\"post\"> \n" );
		...
		if ( userLoggedIn.group == 1 )
		{
			...
			printf (" <b>Nome do novo Tipo de Cerveja</b>:<br> \n" );
			printf ("  <input type='text' name='geBeerType' maxlength='%u'><br>\n", BEER_NAME_MAX_LENGTH );
			printf (" <b>Descri&ccedil;&atilde;o r&aacute;pida sobre o tipo de cerveja</b>:<br> \n" );
	...
	else
	{
		...
		if ( userLoggedIn.group == 1 )
		{
			...
			printf ("  <input type='text' name='geBeerType' maxlength='%u'><br>\n", BEER_NAME_MAX_LENGTH );
			printf (" <b>Brief description about Beer Type</b>:<br> \n" );
			printf (" <input type='text' name='geComment' maxlength='%u'><br>\n", COMMENT_MAX_LENGTH );
