 ...
 * $Log: geCgiChangeBeerTypeName.c,v $
...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		printf (" <b>Listagem de todas os tipos de cervejas</b>:<br>\n" );
		...
		printf ("<form action=\"geExecuteChangeBeerTypeName.cgi\" method=\"post\"> \n" );
		...
		{		
			...
			printf (" <b>Novo nome</b>:<br>\n" );
			printf ("  <input type='text' name='geBeerTypeNew' maxlength='%u'><br>\n", BEER_NAME_MAX_LENGTH );
			printf ("  <input type=\"submit\" name=\"submit\" value=\"Mudar\"><br> \n" );
			fclose ( reading );
		}
	...
	else
	{
		...
		{		
			...
			printf (" <b>New Beer Type's Name</b>:<br>\n" );
			printf ("  <input type='text' name='geBeerTypeNew' maxlength='%u'><br>\n", BEER_NAME_MAX_LENGTH );
			printf ("  <input type=\"submit\" name=\"submit\" value=\"Change it\"><br> \n" );
			fclose ( reading );
...
/* $RCSfile: geCgiChangeBeerTypeName.c,v $ */
