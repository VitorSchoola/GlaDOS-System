 ...
 * $Date: 2015/01/10 19:07:07 $
 * $Log: geCgiAcceptRejectBrotherhood.c,v $
 * Revision 1.1  2015/01/10 19:07:07  vitor.schoola
 * Initial revision
 *
 *
 */
...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		printf(" Aceitar/Recusar convites para Confraria: <br>\n" );
		printf(" Voc&ecirc; possui convites nas confrarias:<br> \n" );
		
		/* Check if Brotherhood.invited File exists */
		
		if ( fileExists ( "../Files/", "Brotherhood.invited" ) == 0 )
		{
			mlCgiShowErrorPage ( "Ops", "N&atilde;o h&aacute; nenhum convite para confraria no sistema.", "" );
			printf ( "<div align=\"center\">" );
		...
		printf ("<form action=\"geExecuteAcceptRejectBrotherhood.cgi\" method=\"post\"> \n" );
		...
		printf (" Aceitar <input type='radio' name='accorrej' value='a' checked> Rejeitar <input type='radio' name='accorrej' value='r'><br>\n" );
		
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Aceitar/Rejeitar\"><br> \n" );
	...
	else
	{
		...
		printf(" Accept/Reject brotherhood invites: <br>\n" );
		printf(" You were invited to the following brotherhoods:<br> \n" );
		
		/* Check if Brotherhood.invited File exists */
		
		if ( fileExists ( "../Files/", "Brotherhood.invited" ) == 0 )
		{
			mlCgiShowErrorPage ( "Ops", "There is no brotherhood invite in our system.", "" );
			printf ( "<div align=\"center\">" );
		...
		printf (" Accept <input type='radio' name='accorrej' value='a' checked> Reject <input type='radio' name='accorrej' value='r'><br>\n" );
		
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Accept/Reject\"><br> \n" );
...
/* $RCSfile: geCgiAcceptRejectBrotherhood.c,v $ */
