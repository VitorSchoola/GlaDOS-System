 ...
 * $Log: geCgiExecuteRemoveBeerType.c,v $
...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( mlCgiGetFormStringNoNewLines ( "geBeerType", geBeerType, BEER_NAME_MAX_LENGTH ) != ML_CGI_OK )
	{
		if ( language == portuguese ) 
		{
			...
			printf ( "<div align=\"center\">" );
			createButton ( "Voltar para a p&aacute;gina anterior.", "geRemoveBeerType.cgi", geLanguage, geNickname, "18" );
		...
		else
		{
			...
			printf ( "<div align=\"center\">" );
			createButton ( "Go back.", "geRemoveBeerType.cgi", geLanguage, geNickname, "18" );
	...
	if ( language == portuguese )
	{
		...
		printf("    Remover Tipo de Cervejas: <br>\n" );
		
		/* Removes Beer Type */
		
		reading = fopen ( "../Files/BeerTypes", "r" );
		writing = fopen ( "../Files/BeerTypes.r", "w" );
		...
		rename ( "../Files/BeerTypes.r", "../Files/BeerTypes" );
		...
		printf (" <b>Tipo de Cerveja Deletado</b>: %s<br>", geBeerType );
		
		printf ( "     </form>\n" );
		createButton ( "Voltar para p&aacute;gina de sele&ccedil;&atilde;o de tipo de cerveja.", "geRemoveBeerType.cgi", geLanguage, geNickname, "444" );
	...
	else
	{
		...
		printf (" <b>Deleted Beer Type</b>: %s<br>", geBeerType );
		
		printf ( "     </form>\n" );
		createButton ( "Go back to the Selection Page.", "geRemoveBeerType.cgi", geLanguage, geNickname, "444" );
...
/* $RCSfile: geCgiExecuteRemoveBeerType.c,v $ */
