...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		printf("    Procurar tipo de cerveja: <br>\n" );
		
		/* Check if Beer Type File exists */
		...
		printf ("<form action=\"geExecuteSearchBeerType.cgi\" method=\"post\"> \n" );
		...
		printf (" Qual tipo de cerveja voc&ecirc; est&aacute; procurando? <br>\n" );
		printf ("  <input type='text' name='searchBeerType'><br>\n" );
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Cad&ecirc; minha cerveja?\"><br> \n" );
	...
	else
	{
		...
		printf (" What's the name ( or part of it ) of the Beer Type you're looking for? <br>\n" );
		printf ("  <input type='text' name='searchBeerType'><br>\n" );
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Where is my beer?\"><br> \n" );
...
/* $RCSfile: geCgiSearchBeerType.c,v $ */
