...
//	printf("        alert ( \"Cookie Found\" ); \n" );
	...
	if ( language == portuguese )
	{
		...
		printf ("<form action=\"geExecuteSearchUser.cgi\" method=\"post\"> \n" );
		...
		printf (" Quem voc&ecirc; deseja procurar? ( Use e-mail ou nome )<br>\n" );
		printf ("  <input type='text' name='searchUserName'><br>\n" );
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Procurar\"><br> \n" );
	...
	else
	{
		...
		printf (" Who are you looking for? ( Use his e-mail or name )<br>\n" );
		printf ("  <input type='text' name='searchUserName'><br>\n" );
		printf ("  <input type=\"submit\" name=\"submit\" value=\"Search\"><br> \n" );
